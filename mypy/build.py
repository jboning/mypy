...
class BuildManager:
    ...
    def parse_file(self, id: str, path: str, source: str, ignore_all: bool) -> MypyFile:
        ...
        self.errors.set_file_ignored_lines(path, tree.ignored_lines, ignore_all)
        return tree
...
class State:
    ...
    def parse_file(self) -> None:
        ...
        with self.wrap_context():
            ...
            self.tree = manager.parse_file(self.id, self.xpath, source, self.ignore_all)
